...
class BLIP2CaptionGenerator:
    """Handles image captioning using BLIP-2 model.
    
    This class manages the loading of the BLIP-2 model and provides methods
    for generating, saving, and visualizing image captions.
    
    Attributes:
        device (torch.device): Device to run the model on
        model (Blip2ForConditionalGeneration): BLIP-2 model
    ...
    def __init__(self, model_name: str = "Salesforce/blip2-opt-2.7b"):
        ...
        Args:
            model_name (str): Name of the BLIP-2 model to use
        """
